...
export DESKTOP_PACKAGES="alsa-utils dbus-user-session fonts-wqy-microhei gnome-icon-theme gogglesmm icewm netsurf-gtk polkitd xdm xfe xorg xserver-xorg-video-wmt xterm"
