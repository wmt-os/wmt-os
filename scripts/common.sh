...
# Kernel flavor: kernels are linux-image-<release> (release ends -$KERNEL_FLAVOR-g<commit>);
# the stable-named metapackage $PACKAGE_NAME the image installs tracks the newest.
